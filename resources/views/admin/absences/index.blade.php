    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Kelola data absensi guru</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left font-semibold text-gray-700 uppercase tracking-wider">Guru
                                Pengganti</th>
                            ...
                            <th class="px-6 py-3 text-left font-semibold text-gray-700 uppercase tracking-wider">Alasan</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        @forelse($absences as $absence)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-gray-900">
                                    {{ $absence->substituteTeacher->name ?? '-' }}</td>
                                ...
                                <td class="px-6 py-4 text-gray-900 max-w-xs truncate" title="{{ $absence->reason }}">
                                    {{ $absence->reason ?? '-' }}
                                </td>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                    ...
                    <div class="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-3">
                        <div>
                            ...
                            <p class="font-medium text-gray-800">{{ $absence->substituteTeacher->name ?? '-' }}</p>
                        </div>
                        <div>
                            <span class="text-gray-400">Alasan:</span>
                            <p class="font-medium text-gray-800">{{ $absence->reason ?? '-' }}</p>
                        </div>
                    </div>
