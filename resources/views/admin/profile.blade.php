...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        @if (session('success'))
            <div class="mb-4 px-4 py-2 bg-green-100 text-green-700 rounded-lg">{{ session('success') }}</div>
        @endif
        ...
        <form method="POST" action="{{ route('admin.profile.update') }}"
            ...
            <button type="submit"
                class="mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Simpan
                Perubahan</button>
        </form>
        ...
        <form method="POST" action="{{ route('admin.profile.password') }}"
            ...
            <button type="submit"
                class="mt-4 px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">Update
                Password</button>
        </form>
    </div>
@endsection
