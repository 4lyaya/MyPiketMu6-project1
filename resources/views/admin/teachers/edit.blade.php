...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Guru</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui informasi guru</p>
        </div>
