...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Daftar Guru</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola informasi seluruh guru</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left font-semibold text-gray-700 uppercase tracking-wider">Telepon
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        @forelse($teachers as $teacher)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-gray-900 font-medium">{{ $teacher->name }}</td>
