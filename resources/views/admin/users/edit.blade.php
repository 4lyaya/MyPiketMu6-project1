...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        @if ($errors->any())
            <div id="alert-error"
                class="flex items-center gap-3 p-4 mb-5 text-red-800 dark:text-red-200 rounded-xl bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800">
                ...
                <button data-dismiss-target="#alert-error" aria-label="Close"
                    class="ml-auto -mx-1.5 -my-1.5 bg-red-50 dark:bg-red-900/30 text-red-500 dark:text-red-400 rounded-lg p-1.5 hover:bg-red-200 dark:hover:bg-red-800">
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Password
                        <span class="text-gray-500 dark:text-gray-400 font-normal">(Kosongkan jika tidak ingin
                            diubah)</span>
                    </label>
