...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Daftar Kelas</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Kelola data kelas yang tersedia</p>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                    <i class="fas fa-school text-4xl mb-3 text-gray-300 dark:text-gray-600"></i>
            ...
            @forelse($classrooms as $classroom)
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <div class="flex items-center justify-between mb-3">
                        <p class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $classroom->name }}</p>
                        <span
