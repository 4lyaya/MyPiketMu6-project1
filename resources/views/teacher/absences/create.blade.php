    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Isi formulir untuk mencatat absensi guru</p>
            </div>
            ...
            <form action="{{ route('guru.absences.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="note" name="note" rows="3" placeholder="Tambahkan catatan tambahan (opsional)"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('note') border-red-500 @enderror">{{ old('note') }}</textarea>
                    @error('note')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
