    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <div
            ...
            <div class="mt-6 text-sm text-gray-500 dark:text-gray-400">
                Dikembangkan oleh <span class="font-semibold text-blue-600 dark:text-blue-400">{{ $app['developer'] }}</span>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
                @foreach ([['name' => 'Laravel 10', 'icon' => 'fa-laravel', 'color' => 'text-red-600'], ['name' => 'Tailwind CSS 3', 'icon' => 'fa-css3-alt', 'color' => 'text-blue-600'], ['name' => 'MySQL 8', 'icon' => 'fa-database', 'color' => 'text-green-600'], ['name' => 'mPDF / Excel', 'icon' => 'fa-file-export', 'color' => 'text-purple-600']] as $tech)
